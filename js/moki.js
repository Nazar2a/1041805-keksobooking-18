...
// функция, выбирает случайный элемент массива
...
// функция сортировки массива случайным образом, без повторений
  ...
  var creationArrays = function (amountElements) {
    ...
    for (var i = 0; i < amountElements; i++) {
      object.push({
        ...
        location: {
          x: randomNumber(window.similarListElement.offsetLeft, window.similarListElement.offsetWidth),
